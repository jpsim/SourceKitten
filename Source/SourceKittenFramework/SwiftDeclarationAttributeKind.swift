...
public enum SwiftDeclarationAttributeKind: String, CaseIterable {
    ...
    // Only available in Swift >= 6.3
    case _noManualOwnership = "source.decl.attribute._noManualOwnership"
    case section = "source.decl.attribute.section"
    case abi = "source.decl.attribute.abi"
    case unsafe = "source.decl.attribute.unsafe"
    case export = "source.decl.attribute.export"
    case constInitialized = "source.decl.attribute.constInitialized"
    case _unsafeSelfDependentResult = "source.decl.attribute._unsafeSelfDependentResult"
    case specialized = "source.decl.attribute.specialized"
    case lifetime = "source.decl.attribute.lifetime"
    case concurrent = "source.decl.attribute.concurrent"
    case safe = "source.decl.attribute.safe"
    case _addressableSelf = "source.decl.attribute._addressableSelf"
    case const = "source.decl.attribute.const"
    case used = "source.decl.attribute.used"
    case _addressableForDependencies = "source.decl.attribute._addressableForDependencies"
    case c = "source.decl.attribute.c"
