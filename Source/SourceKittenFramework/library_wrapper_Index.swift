...
internal let clang_executeOnThread: @convention(c) ((@convention(c) (UnsafeMutablePointer<Void>) -> Void)!, UnsafeMutablePointer<Void>, UInt32) -> () = library.loadSymbol("clang_executeOnThread")
