...
class SourceKitTests: XCTestCase {
    ...
    func testConversion() {
        sourcekitd_request_description_dump(toSourceKit("abcd")!)
        sourcekitd_request_description_dump(toSourceKit(123 as Int64)!)
        sourcekitd_request_description_dump(toSourceKit(["abcd", 123 as Int64])!)
        sourcekitd_request_description_dump(toSourceKit(["abcd": 123 as Int64])!)
        sourcekitd_request_description_dump(toSourceKit(["abcd": 123 as Int64, "yolo": ["abcd": 123 as Int64]])!)
    }
